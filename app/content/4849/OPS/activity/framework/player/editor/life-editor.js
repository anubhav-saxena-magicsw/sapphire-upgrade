...
define(['marionette', 'player/editor/base-editor'], function(Marionette, BaseEditor) {
	 ...
	 * @access private
	 */
	LifeEditor.prototype.getComponent = function(compData, isSimComp) {
	 ...
	 * @access private
	 */
	LifeEditor.prototype.createCompData = function(compData) {
	 ...
	 * @access private
	 */
	LifeEditor.prototype.onComponentCreationComplete = function(objComponent) {
		this.objComp = objComponent;
		this.objComp.defaultData = this.defaultCompData;
		this.componentCreated();
	};

	LifeEditor.prototype.updateComponent = function(objComponent, objData) {
	...
	LifeEditor.prototype.replaceClassProp = function(cl, prop, val) {
		if (!cl || !prop || !val) {
...
/*
	 ...
	 * @access private
	 */
	LifeEditor.prototype.destroy = function() {
		return LifeEditor.__super__.destroy(true, this);
	};
