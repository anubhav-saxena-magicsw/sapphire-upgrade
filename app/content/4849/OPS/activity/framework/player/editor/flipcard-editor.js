...
define(['marionette', 'player/editor/base-editor'], function(Marionette, BaseEditor) {'use strict';
    ...
    /**
     * FlipcardEditor is responsible to load and return slider component class
     * signature and also prepare default data which is required by an slider
     * to initlized itself
     *
     *@augments FlipcardEditor
     *@example
     *Load module
     *
     var objFlipcardEditor = BaseEditor.extend({

	 FlipcardEditor.prototype.getComponent = function(compData) {
     ...
     return objFlipcardEditor;
     */

    FlipcardEditor = BaseEditor.extend({
        defaultCompData : {}
    });
     ...
     * @return none
     * @memberof FlipcardEditor
     * @access private
     */
    FlipcardEditor.prototype.getComponent = function(compData, isSimComp) {
     ...
     * @param {Object} compData
     * @return none
     * @memerof FlipcardEditor
     * @access private
     */
    FlipcardEditor.prototype.createCompData = function(compData) {
     ...
     * @access private
     */
    FlipcardEditor.prototype.onComponentCreationComplete = function(objComponent) {
        this.objComp = objComponent;
        this.objComp.defaultData = this.defaultCompData;
        this.componentCreated();
    };
    
    FlipcardEditor.prototype.updateComponent = function(objComponent, objData) {
		var strPropertyName = objData.actionKeys[objData.actionKeys.length - 1].toLowerCase();
		console.log(this.objComp);
		objComponent.attrChange(strPropertyName, objData.data[strPropertyName]);
		//objComponent.model.set(strPropertyName, objData.data[strPropertyName]);
		//objComponent.render();
	};

    /**
     * This method destroy the FlipcardEditor class.
     * @param none
     * @return none
     * @memberof FlipcardEditor
     * @access private
     */
    FlipcardEditor.prototype.destroy = function() {
        return FlipcardEditor.__super__.destroy(true, this);
    };

    return FlipcardEditor;
});
