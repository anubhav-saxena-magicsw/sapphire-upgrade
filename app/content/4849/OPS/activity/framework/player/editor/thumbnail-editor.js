...
define(['marionette', 'player/editor/base-editor'], function(Marionette, BaseEditor) {
	...
	/**
	 * LifeEditor is responsible to load and return slider component class
	 ...
	 *
	 ...
	 LifeEditor.prototype.getComponent = function(compData) {
	...
	ThumbnailEditor = BaseEditor.extend({
		defaultCompData : {}
	});
	 ...
	 * @access private
	 */
	ThumbnailEditor.prototype.getComponent = function(compData, isSimComp) {
	 ...
	 * @access private
	 */
	ThumbnailEditor.prototype.createCompData = function(compData) {
	 ...
	 * @access private
	 */
	ThumbnailEditor.prototype.onComponentCreationComplete = function(objComponent) {
		this.objComp = objComponent;
		this.objComp.defaultData = this.defaultCompData;
		this.componentCreated();
	};

	ThumbnailEditor.prototype.updateComponent = function(objComponent, objData) {
	...
	ThumbnailEditor.prototype.replaceClassProp = function(cl, prop, val) {
		if (!cl || !prop || !val) {
	 ...
	 * @access private
	 */
	ThumbnailEditor.prototype.destroy = function() {
		return ThumbnailEditor.__super__.destroy(true, this);
	};
