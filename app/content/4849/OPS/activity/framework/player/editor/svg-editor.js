...
define(['marionette', 'player/editor/base-editor'], function(Marionette, BaseEditor) {'use strict';
	 ...
	 * @access private
	 */
	SVGEditor.prototype.getComponent = function(compData, isSimComp) {
	 ...
	 * @access private
	 */
	SVGEditor.prototype.createCompData = function(compData) {
	 ...
	 * @access private
	 */
	SVGEditor.prototype.onComponentCreationComplete = function(objComponent) {
	 ...
	 * @access private
	 */
	SVGEditor.prototype.destroy = function() {
		return SVGEditor.__super__.destroy(true, this);
	};
