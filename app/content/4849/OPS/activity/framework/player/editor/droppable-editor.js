...
define(['marionette', 'player/editor/base-editor'], function(Marionette, BaseEditor) {'use strict';
	...
	/**
	 * DroppableEditor is responsible to load and return slider component class
	 * signature and also prepare default data which is required by an slider
	 * to initlized itself
	 *
	 *@augments DroppableEditor
	 *@example
	 *Load module
	 *
	 var objDroppableEditor = BaseEditor.extend({

	 DroppableEditor.prototype.getComponent = function(compData) {
	 ...
	 return objDroppableEditor;
	 */

	DroppableEditor = BaseEditor.extend({
		defaultCompData : {}
	});
	 ...
	 * @return none
	 * @memberof DroppableEditor
	 * @access private
	 */
	DroppableEditor.prototype.getComponent = function(compData, isSimComp) {
	 ...
	 * @param {Object} compData
	 * @return none
	 * @memerof DroppableEditor
	 * @access private
	 */
	DroppableEditor.prototype.createCompData = function(compData) {
	 ...
	 * @access private
	 */
	DroppableEditor.prototype.onComponentCreationComplete = function(objComponent) {
	...
	/**
	 * This method destroy the DroppableEditor class.
	 * @param none
	 * @return none
	 * @memberof DroppableEditor
	 * @access private
	 */
	DroppableEditor.prototype.destroy = function() {
		return DroppableEditor.__super__.destroy(true, this);
	};

	return DroppableEditor;
});
