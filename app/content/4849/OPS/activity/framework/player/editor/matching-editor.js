...
define(['marionette', 'player/editor/base-editor'], function(Marionette, BaseEditor) {
	...
	MatchingEditor = BaseEditor.extend({
		defaultCompData : {}
	});
	 ...
	 * @access private
	 */
	MatchingEditor.prototype.getComponent = function(compData, isSimComp) {
	 ...
	 * @access private
	 */
	MatchingEditor.prototype.createCompData = function(compData) {
	 ...
	 * @access private
	 */
	MatchingEditor.prototype.onComponentCreationComplete = function(objComponent) {
		this.objComp = objComponent;
		this.objComp.defaultData = this.defaultCompData;
		this.componentCreated();
	};

	MatchingEditor.prototype.updateComponent = function(objComponent, objData) {
	...
	MatchingEditor.prototype.replaceClassProp = function(cl, prop, val) {
		if (!cl || !prop || !val) {
	 ...
	 * @access private
	 */
	MatchingEditor.prototype.destroy = function() {
		return MatchingEditor.__super__.destroy(true, this);
	};
