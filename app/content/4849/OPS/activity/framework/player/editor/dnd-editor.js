...
define(['marionette', 'player/editor/base-editor'], function(Marionette, BaseEditor) {'use strict';
	...
	/**
	 * DndEditor is responsible to load and return slider component class
	 ...
	 *Load module
	 *
	 var objDndEditor = BaseEditor.extend({

	 DndEditor.prototype.getComponent = function(compData) {
	 ...
	 * @access private
	 */
	DndEditor.prototype.getComponent = function(compData, isSimComp) {
	 ...
	 * @access private
	 */
	DndEditor.prototype.createCompData = function(compData) {
	 ...
	 * @access private
	 */
	DndEditor.prototype.onComponentCreationComplete = function(objComponent) {
	...
	/**
	 * This method destroy the DndEditor class.
	 * @param none
	 * @return none
	 * @memberof DndEditor
	 * @access private
	 */
	DndEditor.prototype.destroy = function() {
		return DndEditor.__super__.destroy(true, this);
	};
