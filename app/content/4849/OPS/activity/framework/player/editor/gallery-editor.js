...
define(['marionette', 'player/editor/base-editor'], function(Marionette, BaseEditor) {'use strict';
	...
	GalleryEditor = BaseEditor.extend({
		defaultCompData : {}
	});
	 ...
	 * @access private
	 */
	GalleryEditor.prototype.getComponent = function(compData, isSimComp) {
	 ...
	 * @access private
	 */
	GalleryEditor.prototype.createCompData = function(compData) {
	 ...
	 * @access private
	 */
	GalleryEditor.prototype.onComponentCreationComplete = function(objComponent) {
	...
	GalleryEditor.prototype.destroy = function() {
		return GalleryEditor.__super__.destroy(true, this);
	};
