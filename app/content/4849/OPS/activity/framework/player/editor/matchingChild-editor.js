...
define(['marionette', 'player/editor/base-editor'], function(Marionette, BaseEditor) {
	...
	MatchingChildEditor = BaseEditor.extend({
		defaultCompData : {}
	});
	 ...
	 * @access private
	 */
	MatchingChildEditor.prototype.getComponent = function(compData, isSimComp) {
	 ...
	 * @access private
	 */
	MatchingChildEditor.prototype.createCompData = function(compData) {
	 ...
	 * @access private
	 */
	MatchingChildEditor.prototype.onComponentCreationComplete = function(objComponent) {
	...
	/*
	MatchingChildEditor.prototype.updateComponent = function(objComponent, objData) {
			console.log("**************")
	...
	MatchingChildEditor.prototype.replaceClassProp = function(cl, prop, val) {
		if (!cl || !prop || !val) {
	 ...
	 * @access private
	 */
	MatchingChildEditor.prototype.destroy = function() {
		return MatchingChildEditor.__super__.destroy(true, this);
	};

	return MatchingChildEditor;
});
