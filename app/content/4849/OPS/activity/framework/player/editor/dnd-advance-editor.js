...
define(['marionette', 'player/editor/base-editor'], function(Marionette, BaseEditor) {'use strict';
	...
	DnDAdvanceEditor = BaseEditor.extend({
		defaultCompData : {}
	});
	 ...
	 * @access private
	 */
	DnDAdvanceEditor.prototype.getComponent = function(compData, isSimComp) {
	 ...
	 * @access private
	 */
	DnDAdvanceEditor.prototype.createCompData = function(compData) {
	 ...
	 * @access private
	 */
	DnDAdvanceEditor.prototype.onComponentCreationComplete = function(objComponent) {
	 ...
	 * @access private
	 */
	DnDAdvanceEditor.prototype.destroy = function() {
		return DnDAdvanceEditor.__super__.destroy(true, this);
	};

	return DnDAdvanceEditor;
});
