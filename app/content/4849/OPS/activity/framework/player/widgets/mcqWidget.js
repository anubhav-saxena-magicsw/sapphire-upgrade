$.widget("Template.MCQ", {
	...
	_checkAnswer : function(e, t, s, i) {
	   ...
	   if(this.options.ctype==='clickwords'){
		...
		this._arraysIdentical(n.slice(0).sort(), a.slice(0).sort()) ? this._trigger("ON_CORRECT_ANSWER", {}, s) : this._trigger("ON_INCORRECT_ANSWER", {}, s)
	},
	reset : function() {
	...
	result : function() {
		...
		this.options.answersArray.length === this.uuid + 1 && this._trigger("ON_SHOW_RESULT", {}, e)
	},
	showFeedback : function() {
		...
		this._trigger("ON_SHOW_FEEDBACK");
